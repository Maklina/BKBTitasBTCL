<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BranchWiseBTCLBillDetail.aspx.cs" Inherits="BKBTitas.ReportFile.ASPXFile.BranchWiseBTCLBillDetail" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <asp:ScriptManager ID="ScriptManager1" runat="server">
         ...
         <rsweb:ReportViewer ID="rvBranchWiseBTCLBillDetail" runat="server" Style="" Width="100%" Height="100%" ZoomMode="PageWidth"
            ...
            <LocalReport ReportPath="ReportFile\RDLCFIle\BranchWiseBTCLBillDetail.rdlc">
